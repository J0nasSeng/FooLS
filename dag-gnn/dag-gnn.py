...
parser.add_argument('--data_variable_size', type=int, default=3,
...
parser.add_argument('--scale1', type=float, default=1., 
                    help='Scale1 of data generating process')
parser.add_argument('--scale2', type=float, default=1., 
                    help='Scale2 of data generating process')
parser.add_argument('--attack-scale0', type=float, default=1., 
                    help='Attack-Scale0')
parser.add_argument('--attack-scale1', type=float, default=1., 
                    help='Attack-Scale1')
parser.add_argument('--attack-scale2', type=float, default=1., 
                    help='Attack-Scale2')
...
# ================================================
train_loader, valid_loader, test_loader, ground_truth_G = load_n_node_data(args, args.batch_size)
